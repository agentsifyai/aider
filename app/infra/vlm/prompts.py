...
#TODO: refactor this to adhere to Prompts class

SCANNED_REPORT_SYSTEM_PROMPT = """
...
def get_scanned_report_messages(file_path: str) -> list[dict[str, str]]:
    """
    ...
    return [
    {
      ...
      "content": [
        {
          "type": "text",
          "text": SCANNED_REPORT_SYSTEM_PROMPT
        }
      ]
    },
    {
      ...
      "content": [
        {
          "type": "text",
          "text": "Hey please provide a markdown content of this document:"
        },
        {
          "type": "file",
          "file": {
